...
PardotAPI_v3.prototype.execute = function (resource, method, availableParams, givenParams, callback) {
  ...
  // TODO extracted this uri to test. pretty sure this is the incorrect syntax
  // TODO I cannot get pardot to respond to any requests properly.
  // TODO API documentation uses the term object instead of resource
  // TODO API documentation uses the term operation instead of method
  ...
  request({
    ...
    if (error) {
      ...
      if (self.DEBUG) {console.log(JSON.stringify(error));}
      ...
      if (self.DEBUG) {console.log(JSON.stringify(parsedResponse));}
